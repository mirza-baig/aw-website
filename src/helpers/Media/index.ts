export {
  // getStaticProps as getMediaPrimaryStaticProps,
  default as MediaPrimary,
} from './MediaPrimary/MediaPrimary';
export {
  getStaticProps as getMediaSecondaryStaticProps,
  default as MediaSecondary,
} from './MediaSecondary';
/**
