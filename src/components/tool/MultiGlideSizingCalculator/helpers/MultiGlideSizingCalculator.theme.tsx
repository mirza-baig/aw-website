  ...
  return {
    aw: {
      classes: {
        ...
        measurementButton:
          'flex items-center justify-end whitespace-nowrap font-sans text-text-link text-theme-text disabled:border-gray disabled:text-gray md:ml-0 md:w-fit md:px-0 text-sm text-primary',
        ...
        tdColumn: 'px-4 py-2 font-demi',
        tdColumnCenter: ' px-4 py-2 text-center font-demi',
