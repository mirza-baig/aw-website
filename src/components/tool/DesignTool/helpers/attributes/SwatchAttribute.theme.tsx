...
export const SwatchAttributeTheme = (): ThemeFile | SwatchAttributeThemeType => {
  return {
    aw: {
      classes: {
        attributeOption: ` attribute-options attribute-options--swatch swatch-attribute md:ml-[16px] md:mb-[60px] md:mt-[16px] `,
        ...
        optionsListItem: ` attribute-options__list-item mr-[1%] flex-[0_0_24%] max-w-[24%] text-center md:flex-[0_0_15%] md:max-w-[11%] md:mr-[1%]`,
