...
import { FormWrapper } from './helpers/FormWrapper.DesignTool';
import { Sitecore } from '.sitecore/AndersenWindows.model';
import componentMap from '.sitecore/component-map';

type RequestQuoteProps = ComponentProps & Sitecore.Forms.Custom.RequestAQuote.RequestAQuote;

function RequestQuote_DesignTool(props: RequestQuoteProps) {
...
export const DesignTool = withDatasourceCheck(RequestQuote_DesignTool);
