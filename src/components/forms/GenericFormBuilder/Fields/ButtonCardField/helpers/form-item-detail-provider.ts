...
function getInitialValue(
  props: Required<Sitecore.Forms.GenericFormBuilder.Fields.ButtonCard.ButtonCardField>
): ProvidedValues {
...
export async function getFormItemDetail(
  props: Sitecore.Forms.GenericFormBuilder.Fields.ButtonCard.ButtonCardField
  ...
  return standardFieldDetail({
    ...
    templateName: 'ButtonCardField',
    initialValue: getInitialValue(
      props as Required<Sitecore.Forms.GenericFormBuilder.Fields.ButtonCard.ButtonCardField>
    ),
    hideOnLoad: false,
