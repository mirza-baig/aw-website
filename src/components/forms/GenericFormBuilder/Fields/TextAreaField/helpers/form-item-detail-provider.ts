...
function getValidationSchema(
  props: Required<Sitecore.Forms.GenericFormBuilder.Fields.TextArea.TextAreaField>
): Schema | undefined {
...
export async function getFormItemDetail(
  props: Sitecore.Forms.GenericFormBuilder.Fields.TextArea.TextAreaField
  ...
  return standardFieldDetail({
    ...
    initialValue: getInitialValue(
      props as Required<Sitecore.Forms.GenericFormBuilder.Fields.TextArea.TextAreaField>
    ),
    hideOnLoad: false,
