...
function getInitialValue(
  props: Required<Sitecore.Forms.GenericFormBuilder.Fields.Email.EmailField>
): ProvidedValues {
...
export async function getFormItemDetail(
  props: Sitecore.Forms.GenericFormBuilder.Fields.Email.EmailField
  ...
  return standardFieldDetail({
    ...
    initialValue: getInitialValue(
      props as Required<Sitecore.Forms.GenericFormBuilder.Fields.Email.EmailField>
    ),
    hideOnLoad: false,
