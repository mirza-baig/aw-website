...
import { ComponentSpacing } from './HeadlineWithNavigation.types';

export const HeadlineWithNavigationTheme = (
  ...
  return {
    aw: {
      classes: {
        ...
        linkContainer: classNames(
          'relative bottom-0 flex flex-col bg-white px-6 pt-xs align-middle',
          isForProfessionals ? 'ml:bottom-20.5' : 'ml:bottom-10',
          'ml:mx-m ml:flex-row ml:items-center ml:rounded-full ml:pt-0 ml:shadow-md lg:mx-xl'
        ),
        ...
        linkWrapperStyle:
          'font-sans relative flex w-full grow items-center font-heavy hover:underline hover:decoration-black hover:underline-offset-8 ml:justify-center ml:px-2',
