...
import {
  ImgFieldFragment,
  LnkFieldFragment,
  ProductConfigItemQueryResultFragment,
  ProductItemQueryResultFragment,
  ProductQueryResultFragment,
  ProductTypeFragment,
...
/**
 * Configuration options for @see GraphQLDesignToolProductByIdService instances
 */
interface GraphQLDesignToolProductByIdServiceConfig {
  /**
 ...
 * page load size.
 */
export class GraphQLDesignToolProductByIdService {
  protected get query(): string {
    return defaultQuery;
  }

  constructor(public options: GraphQLDesignToolProductByIdServiceConfig) {}
